...
def fake_generate_shorts(**kwargs):
    ...
    # each stage transition instead of only starting/done.
        ...
        "shorts": [
            {
                ...
                "clip_url": (os.path.abspath("output/short_01.mp4") if mode == "local"
...
def main():
    ...
    check("POST /api/generate returns job_id", r.status_code == 202 and bool(job_id), f"body={r.get_json()}")
